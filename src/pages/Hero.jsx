      ...
      <div className="max-w-7xl mx-auto flex  md:flex-row justify-center items-center px-6 md:px-10 py-10 gap-12">
        ...
        <div className="flex-1 text-center">
          ...
          <div className="flex items-center gap-4 mt-6 justify-center">
            <button className="flex items-center gap-2 border border-gray-300 rounded-md px-4 py-2 shadow-sm hover:bg-gray-50 transition">
              <img
                src={play}
                alt="Google Play"
            ...
            <button className="flex items-center gap-2 border border-gray-300 rounded-md px-4 py-2 shadow-sm hover:bg-gray-50 transition">
              <img
                ...
                alt="App Store"
                className="h-4 md:h-10"
              /> <span className="text-md md:text-xl font-semibold">App Store</span>
            </button>
          </div>
        </div>
